        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="error-content text-center">
                    <img src="{{ url('assets/images/errors/500.png') }}" class="mb-50" alt="">
                    <h2>Oops! Something Went Wrong!</h2>
                    <p>The server encountered an internal error, please try again later or click the below button to go to the home. </p>
