    ...
    <div class="container-fluid">
        <div class="primary-menu">
            <div class="site-branding">
                <a href="{{ (Route::has('home')) ? route('home') : 'not-found' }}" class="brand-logo"><img src="{{ url('assets/images/logo/logo-1.png') }}" alt="Site Logo"></a>
            </div>
            <div class="nav-menu">
                <!-- Navbar Close -->
                ...
                <nav class="main-menu">
                    <ul>
                        ...
                        <li class="menu-item has-children">
                            <a href="{{ (Route::has('cp-academy')) ? route('cp-academy') : 'not-found' }}" class="{{ in_array(Route::currentRouteName(), ['cp-academy', 'ai-ml-masterclass-course', 'ai-ml-business-leader']) ? 'active' : '' }}">CP Academy</a>
                            <ul class="sub-menu">
